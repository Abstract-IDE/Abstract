...
pub static ABSTRACT_ROOT: LazyLock<String> =
    LazyLock::new(|| vim_global("ABSTRACT_ROOT").unwrap_or_else(|| nvim_path::nvim_stdpath_str("config")));
...
pub static NVIM_DATA_HOME: LazyLock<String> = LazyLock::new(|| format!("{}/abstract", ABSTRACT_DATA.as_str()));
