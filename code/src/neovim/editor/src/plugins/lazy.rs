...
impl PluginManager {
    ...
    fn validated_spec(lua: &mlua::Lua) -> String {
        ...
        let specs: Vec<(&str, SpecInfo)> = specs![
            ...
            ("configs/abstract-plugs.lua", &[("TERMINAL_MAPPING_SET", MAPPING.set_map_str(Key::AbstractTerminal))]),
            ...
            ("configs/trouble.lua", &[("MAPPING_SET", MAPPING.set_map_str(Key::Trouble))]),
