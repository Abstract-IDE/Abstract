...
return { -- Smart and powerful comment plugin for neovim. Supports commentstring, dot repeat, left-right/up-down motions, hooks, and more
	...
	config = function()
		...
		-- local _ctx_commentstring, ctx_commentstring = pcall(require, "abstract.plugins.nvim-ts-context-commentstring")
		...
		require('Comment').setup({
			...
			pre_hook = require("abstract.plugins.extension.nvim-ts-context-commentstring").config(),
