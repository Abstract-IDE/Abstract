...
local _session, session = pcall(require, "session_manager")
...
-- load sessions
setkeymap("n", "<leader>ss", ":SessionManager load_session<CR>", opts)
-- delete sessions
setkeymap("n", "<leader>sd", ":SessionManager delete_session<CR>", opts)
