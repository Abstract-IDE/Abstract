...
local run      = ":w <CR><bar> :FloatermNew python ~/.config/nvim/extra/tools/lazy-builder/build.py -o ~/.cache/build_files/ -r 1 % <CR><CR>"
local build    = ":w <CR><bar> :FloatermNew time python ~/.config/nvim/extra/tools/lazy-builder/build.py -o ~/.cache/build_files/ -b 1 % <CR><CR>"
local buildrun = ":w <CR><bar> :FloatermNew time python ~/.config/nvim/extra/tools/lazy-builder/build.py -o ~/.cache/build_files/ -br 1 % <CR><CR>"
